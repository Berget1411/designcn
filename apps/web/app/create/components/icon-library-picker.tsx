...
export function IconLibraryPicker({
  ...
  return (
    <div className="group/picker relative">
      <Picker>
        <PickerTrigger>
          <div className="flex flex-col justify-start text-left">
            ...
            <div className="text-sm font-medium text-foreground">{currentIconLibrary?.title}</div>
          </div>
      ...
      <LockButton param="iconLibrary" className="absolute top-1/2 right-8 -translate-y-1/2" />
    </div>
  );
}
