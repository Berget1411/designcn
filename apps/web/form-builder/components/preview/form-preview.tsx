...
export function FormPreview({ form, formElements, isMS, className, onSubmit }: FormPreviewProps) {
    ...
    return (
      <div className="w-full border-dashed rounded-2xl border-[3px] py-24 bg-muted @md/my-forms:px-5 px-4">
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <h2 className="text-center text-lg text-balance font-semibold">Form Preview</h2>
  ...
  return (
    <div
      className={cn(
        ...
        !isMS && formElements[0].hasOwnProperty("static") === true ? "" : "pt-4.5",
        className,
      )}
    >
            ...
            {isMS ? (
              ...
              <div className="grid grid-cols-6 gap-4">
                {(formElements as FormElementOrList[]).map((element, i) => {
                  if (Array.isArray(element)) {
                    return element.map((el, ii) => (
                      <div key={el.name + ii} className="md:col-span-3 col-span-full">
                ...
                <div className="flex items-center justify-end w-full pt-3 gap-3 col-span-6">
                  ...
                  <Button type="submit" className="rounded-lg" size="sm" disabled={isSubmitting}>
