...
import { socialKeys, socialLogsUrls } from "@/form-builder/constant/social-logos-urls";
...
const OptionLabel = ({ label, Icon }: { label: string; Icon: React.ReactNode }) => (
  <TooltipProvider>
    <Tooltip>
      <TooltipTrigger asChild>
        <div role="button" className="size-full flex justify-center items-center">
          {Icon}
        </div>
      </TooltipTrigger>
      <TooltipContent>
...
const socialMediaButtonsVariants = Object.entries(socialLogsUrls).map(([key, value]) => ({
  value: key,
  label: (
  ...
  return (
    <div className="space-y-3 w-full py-1">
      <div className="flex items-center justify-between">
        <Label className="text-sm font-medium">Options ({localOptions.length})</Label>

        <Button type="button" variant="outline" size="sm" onClick={addOption} className="h-8 px-2">
          ...
          <div className="space-y-3">
            ...
            {hasAttribute({
              ...
              <p className="text-destructive-foreground bg-destructive/10 rounded-sm p-2.5 text-sm">
                This element is longer supported, Please use the Text element instead so that you
                switch between different text tags easily
              </p>
            ) : (
              <RenderFormElement
                formElement={{
            ...
            <div className="space-y-2 w-full">
              ...
              <RenderFormElement
                formElement={{
                  ...
                  description: "Comma separated list of MIME types or file extensions",
                  fieldType: "Input",
                  type: "string",
                }}
                form={form}
