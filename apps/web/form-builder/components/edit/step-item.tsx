  ...
  return (
    ...
    >
      <div className="rounded-sm px-3 md:px-4 lg:px-5 md:py-5 py-4 border border-dashed bg-background">
        <motion.div layout className="flex items-center justify-between pb-4" key={stepIndex}>
        ...
        <motion.div layout className="flex items-center justify-between px-2 pt-4">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <Button type="button" className="rounded-lg" onClick={() => addFormStep(stepIndex)}>
              <MdAdd />
              <span>Add Step</span>
            </Button>
          </div>
