...
const ShadcnStudio = () => (
  <a
    href={"https://shadcnstudio.com/?utm_source=formcn&utm_medium=banner&utm_campaign=github"}
    target="_blank"
    ...
    <div className="flex flex-col items-center gap-2.5">
      <div className="flex items-center gap-2 text-foreground/90 group-hover/left:text-primary">
        ...
        <div className="flex flex-col items-start">
          <span className="leading-tight font-medium text-xs sm:text-sm">Shadcnstudio.com</span>
          <span className="text-muted-foreground text-sm">shadcn blocks &amp; templates</span>
        </div>
      </div>
    </div>
  </a>
    ...
    <div className="flex flex-col items-center gap-2.5">
      <div className="flex items-center gap-2 text-foreground/90 group-hover/right:text-primary">
        ...
        <div className="flex flex-col items-start">
          ...
          <span className="text-muted-foreground text-xs ">Free and premium AI tutorials</span>
        </div>
      </div>
    </div>
  </a>
