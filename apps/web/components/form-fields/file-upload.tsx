...
import { formatBytes, useFileUpload } from "@/form-builder/hooks/use-file-upload";
    ...
    <div className="flex flex-col gap-2 pb-2">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-foreground font-medium text-sm mb-2">Drag & drop or click to browse</p>
            ...
            >
              <div className="flex items-center gap-1.5 overflow-hidden">
                ...
                <div className="flex min-w-0 flex-col gap-0.5">
                  <p className="truncate text-[11px] font-medium max-w-[200px]">{file.file.name}</p>
